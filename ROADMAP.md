...
Duck Desk is building toward a free, open-source live seller production toolkit.
...
- Authenticated OBS source setup, repair, canvas fitting, and cache refresh.
- Automatic local saving for creator themes, add-ons, media, and show settings.
- Live preflight health for the app, OBS, extension, seller page, and real event path.

## Next

- More reliable real-show event adapters.
- Event integrity tools: reconnect history, event IDs, duplicate protection, parser fixtures, and a raw event inspector.
- Named show profiles with import, export, backup, and a clean Start New Show action.
- No-code event routing with conditions, cooldowns, priorities, timing, and random media pools.
- A phone show deck for one-handed local control of scenes, sounds, GIFs, timers, and emergency clear.
