...
<p align="center">
  <a href="https://github.com/ConfusedDuckCollectibles/DuckDesk/releases/tag/v0.1.0-alpha.10"><strong>Download for Mac</strong></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/ConfusedDuckCollectibles/DuckDesk/releases/tag/v0.1.0-alpha.10"><strong>Download for Windows</strong></a>
  &nbsp;·&nbsp;
...
> **Public alpha `v0.1.0-alpha.10`.** Download the Mac or Windows installer. You do not need Terminal, PowerShell, or any coding.
...
1. Open **[Duck Desk v0.1.0-alpha.10](https://github.com/ConfusedDuckCollectibles/DuckDesk/releases/tag/v0.1.0-alpha.10)**.
2. Scroll to **Assets**.
3. Download one file:
...
- 63 stream looks: 20 standard, 36 animated premium, 2 character scenes, and 5 audience-powered Game Themes
