...
<p align="center">
  <a href="https://github.com/ConfusedDuckCollectibles/DuckDesk/releases/tag/v0.1.0-alpha.3"><strong>Download for Mac</strong></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/ConfusedDuckCollectibles/DuckDesk/releases/tag/v0.1.0-alpha.3"><strong>Download for Windows</strong></a>
  &nbsp;·&nbsp;
...
> **Public alpha `v0.1.0-alpha.3`.** Download the Mac or Windows installer. You do not need Terminal, PowerShell, or any coding.
